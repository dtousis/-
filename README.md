...
> Άνοιγμα αυτής της σελίδας στο [https://dtousis.github.io/-/](https://dtousis.github.io/-/)
...
* αναζήτηση για **https://github.com/dtousis/-** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/dtousis/-/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/dtousis/-** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/dtousis/-/raw/master/.github/makecode/blocks.png)
